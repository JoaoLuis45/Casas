...
begin
  ...
  mes := 'A casa de número '+numc+' foi desapropiada do inquilino '+nomeinq+' !';
  if Application.MessageBox('Deseja realmente desapropiar essa casa deste inquilino?','Atenção!',MB_ICONEXCLAMATION+MB_OKCANCEL) = mrOk then
    begin
...
begin
    ...
    2: lblTypeUser.Caption := 'Selecione pelo Número da casa:';
    3: lblTypeUser.Caption := 'Selecione pelo CPF do Inquilino:';
  end;
end;

procedure TformDesapropiateHouse.txtFindUserChange(Sender: TObject);
begin
  DM.sqlFindUser.Close;
