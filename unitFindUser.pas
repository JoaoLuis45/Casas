...
uses
  ...
  Vcl.Grids, Vcl.DBGrids, Vcl.Buttons, Vcl.Imaging.pngimage;
...
type
  TformFindUser = class(TForm)
    ...
    procedure btnVisualizationUserClick(Sender: TObject);
  private
...
uses unitCasas, unitDM, unitFindHouse, unitHireHouse, unitInquilinos,
  unitPrincipal, unitRegisterHouse, unitViewUser;

procedure TformFindUser.btnVisualizationUserClick(Sender: TObject);
begin
  formViewUser.ShowModal;
end;
...
begin
  case rgType.ItemIndex of
    ...
    2: lblConsInquilino.Caption := 'Procure pelo Número da Casa:';
